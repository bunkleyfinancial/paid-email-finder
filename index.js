...
// NEW PAYMENT PAGE ROUTE ADDED HERE
          ...
          try {
            ...
            if (tokenResult.status === 'OK') {
              ...
              if (result.success) {
                ...
                document.getElementById('payment-status').textContent = 'Payment failed: ' + (result.error || 'Unknown error');
